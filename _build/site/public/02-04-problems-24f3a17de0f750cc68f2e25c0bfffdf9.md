...
* d. What is the worst-case running time of BUBBLESORT? How does it compare with the running time of I NSERTION-SORT?

## 2-3 Correctness of Horner's rule

You are given the coefficents a0 ; a1 ; a2 ; : : : ; an of a polynomial
P .x/ D
n
X
kD0
ak x k
D a0 C a1 x C a2 x 2 C    C an1 x n1 C an x n ;
...
P .x/ D a0 C x

a1 C x ãa2 C    C x.an1 C xan /    äÍ
:
