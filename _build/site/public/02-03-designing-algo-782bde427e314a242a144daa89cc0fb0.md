...
The recursion "bottoms out" -- it reaches the base case -- when the subarray AŒp W r� to be sorted has just 1 element, that is, when p equals r . As we noted in the ini-
