...
The pseudocode for insertion sort is given as the procedure {sc}`Insertion-Sort`
...
SORT procedure is finished, array AŒ1 W n� contains the original values, but in sorted
order.
