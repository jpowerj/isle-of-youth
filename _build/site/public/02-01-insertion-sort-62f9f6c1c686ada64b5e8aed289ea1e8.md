...
* **Initialization:** We start by showing that the loop invariant holds before the first loop iteration, when $i = 2$.[^2] The subarray AŒ1 W i  1� consists of just the
...
begins on line 1 consists of lines 238, and the body of the while loop tha
